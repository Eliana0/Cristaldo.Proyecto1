  ...
  function suscribirse(){
    ...
    function verDatosSuscriptor(){
      ...
      botonUsuario.addEventListener("click", ()=>{
        ...
        if(suscriptor.mail === mail){
          let nombre= suscriptor.nombre;
          let apellido= suscriptor.apellido;
          let mail= suscriptor.mail;
          let productos= suscriptor.productos;
...
<div class="divContraseña"> <textarea class="password" placeholder="Descripción" id="newLibroDescripcion" style="height: 100px"></textarea></div>
`;
